...
local currentExpenditureInformation = 0
local currentGoalText = nil
local currentExpenditure = nil
local savedEmail = ""
local savedSensorID = ""
...
function goalPanel(panel, sizer)
    ...
    currentGoalText = wx.wxStaticText(panel, CURRENTGOALTEXT, "Current Goal: " .. currentGoal .. " m³")
    currentExpenditure = wx.wxStaticText(panel, CURRENTEXPENDITURE, "Current Expenditure: " .. currentExpenditureInformation .. "m³")
